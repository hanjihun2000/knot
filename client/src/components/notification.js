  ...
  return (
    ...
    return (
      <li key={index} className="row">
        ...
        <button className="accept-button" onClick={() => handleFollowRequest(requestedUser.username, user.username , true)}>accept</button>
        <button className="reject-button" onClick={() => handleFollowRequest(requestedUser.username, user.username, false)}>reject</button>
      </li>
    );
  })}
      </ul>
