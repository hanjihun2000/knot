  ...
  const handlePrivacyToggle = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/api/userapi/editUserProfile",
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div className="profile-edit">
      ...
      <form className="privacy-form">
        ...
        <p>
          On the other hand, if your account is private, only the followers you
          have approved will have access to your shared posts.
        </p>

        <p>
          If your account is set to public, anyone can view your posts, whether
          they have a Knot account or not.
        </p>
      </form>
    </div>
  );
